<template>
	<view>
		...
		<uni-card>
			...
			<view>
				<view class="favourPrice">
				<u--text :text="goodsDetailData.favourPrice" size="50"></u--text>
			</view>
			</view>
		</uni-card>
		<uni-card>
		...
		<uni-card>
			<view class="content">
				<u--text :text="goodsDetailData.desc" size="30"></u--text>
			</view>
		</uni-card>
		<uni-card>
			<!-- 商品其他图片 -->
		...
		<view class="nav">
			...
			<u-row>
				...
				<u-col span="7" customStyle="padding-right:15px;margin:5px 0">
					<u-button type="primary" text="立即购买" shape="circle" color="#e1251b" @click="goto(`/pages/payOrder/payOrder?goodsID=${this._id}&goodsNum=1`)"></u-button>
				</u-col>
			</u-row>
		</view>
