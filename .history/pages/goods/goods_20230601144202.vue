<template>
	...
	<view>
		...
		<u-overlay :show="overlayShow" :opacity="0.7">
			<view class="warp">
				<u-loading-icon textColor="#409EFF" color="#409EFF" inactive-color="#409EFF" size="70" mode="semicircle" textSize="40" text="加载中"></u-loading-icon>
			</view>
		</u-overlay>
		<!-- 搜索 -->
		<view class="">
			<u-search inputAlign="center" v-model="searchVal" height="90" borderColor="#C0C4CC"
				searchIconColor="#409EFF" bgColor="#FFFFFF" :searchIconSize="50" shape="square" :clearabled="true"
				:showAction="true" actionText="搜索" :animation="true" @custom="search()" @clear="clear()"
				@search="search()"></u-search>
		</view>
		<!-- 空数据 -->
		<view class="">
			<u-empty marginTop="100rpx" :show="isEmpty" mode="search"
				icon="http://cdn.uviewui.com/uview/empty/search.png" :width="screenWidth" :height="screenHeight"
				textSize="40">
			</u-empty>
		</view>
		<!-- 列表内容 -->
		<view class="content" v-show="!isEmpty">
			<view class="uni-product-list">
				<view class="uni-product" v-for="(product, index) in productList" :key="index">
					<view class="" @click="
              goto(`/pages/business/goodsDetail/goodsDetail?goodsID=${product._id}`)
            ">
						<view class="image-view">
							<image class="uni-product-image" :src="product['image']['url']"></image>
						</view>
