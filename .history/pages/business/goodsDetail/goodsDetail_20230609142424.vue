  ...
  <view>
    ...
    <uni-card>
      ...
      <view>
        ...
        <u-row
          justify="flex-start"
          customStyle="margin-top: 30rpx;margin-bottom: 20rpx"
        >
          <u-col span="5">
        ...
        <u-row customStyle="margin-top: 20rpx;margin-bottom: 10rpx">
          <u-col span="10">
            <span class="originalPrice">原价 ¥ </span
            ><span class="huaxian">{{ goodsDetailData.originalPrice }}</span>
          </u-col>
        </u-row>
      </view>
    </uni-card>
    ...
    <view class="nav">
      ...
      <u-row justify="space-between" gutter="10" style="margin-top: 10upx">
        ...
        <u-col
          span="6"
          customStyle="padding-right:5upx;margin:5px 0"
          getter="4"
        >
          <!-- 立即购买 -->
...
export default {
  ...
  onLoad(options) {
    ...
    if (query.sharerOpenID == undefined || query.sharerOpenID == "") {
      ...
      console.log("shareGoodsID", shareGoodsID);
    }
  ...
  onShareAppMessage() {
    ...
    return {
      ...
      path: `/pages/business/goodsDetail/goodsDetail?goodsID=${
        this.goodsID
