<template>
	...
	<view>
		<view>
			...
			<uni-pay ref="uniPay" v-show="false" @mounted="onMounted" @success="onSuccess"
				@fail="onFail" @create="onCreate" @cancel="onCancel" return-url="/pages/business/order/order?orderStatus=1"></uni-pay>
			<view class="">
				<uni-card class="card">
				...
				<uni-card class="card">
					...
					<u-row gutter="12">
						...
						<u-col span="6" offset="0">
							<text
								style="margin-bottom: 100rpx;font-size: 40rpx;color:#c8c9cc;">¥{{ goodsInfo.originalPrice}}元</text>
						</u-col>
					</u-row>
					<u-row gutter="12">
						<!-- 占位 -->
					...
					<u-row gutter="12">
						...
						<u-col span="6" offset="0">
							<!-- 原价减去现价 -->
							<text
								style="margin-bottom: 100rpx;font-size: 40rpx;color:#c8c9cc;">¥{{ goodsInfo.originalPrice-goodsInfo.favourPrice }}元</text>
						</u-col>
					</u-row>
					<u-row gutter="12">
						<!-- 占位 -->
					...
					<u-row gutter="12">
						...
						<u-col span="6" offset="0">
							<text
								style="margin-bottom: 100rpx;border: 10rpx;font-size: 40rpx;color: orange;">¥{{ (goodsInfo.favourPrice)*1 }}元</text>
						</u-col>
					</u-row>
					<u-row gutter="12">
						<!-- 占位 -->
...
<script>
	...
	export default {
		...
		onLoad(options) {
			...
			// 商品ID
			this.orderGoodsID = uni.getStorageSync("goodsID");
			console.log(`商品ID：${this.orderGoodsID}`);
			// 请求商品信息
			uniCloud.callFunction({
				name: "goods",
				data: {
