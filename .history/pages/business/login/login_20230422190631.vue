	...
	<view class="loginContent">
		<view class="wrap">
			...
			<view class="buttom">
				...
				<view class="phone item" @click="goto('/pages/login/mobileLogin')">
					<view class="icon">
						<u-icon size="70" name="phone-fill" color="rgb(83,194,64)"></u-icon>
					</view>
					手机号
				</view>
				<view class="QQ item" @click="goto('/pages/login/mobileLogin')">
					<view class="icon">
				...
				<view class="hint">
					...
					<text class="link" style="color: blue;"
						@click="goto('/pages/articlesAgreement/articlesAgreement')">用户协议、隐私政策，</text>
