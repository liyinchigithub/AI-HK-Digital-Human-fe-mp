	...
	<view>
		...
		<view class="">
			<u-row customStyle="margin-top:30rpx;margin-bottom: 10px">
				<u-col span="12">
					<u-steps current="0"  :iconSize="250" :labelSize="250">
						<u-steps-item title="填写申请表"  :iconSize="250" :labelSize="250">
						</u-steps-item>
						<u-steps-item title="官方审核"  :iconSize="250" :labelSize="250"></u-steps-item>
						<u-steps-item title="入驻成功" :iconSize="250" :labelSize="250"></u-steps-item>
					</u-steps>
				</u-col>
				<u-col span="6">
				</u-col>
				...
				<u-col span="6">
					...
					<view class="demo-layout bg-purple-light">
						<u-button type="primary" text="商家申请入驻"
							@click="goto('/pages/business/merchantSettlement/merchantSettlement')">
						</u-button>
					</view>
				</u-col>
				<u-col span="6">
					...
					<view class="demo-layout bg-purple">
						<u-button type="success" text="个人申请入驻" @click="goto('/pages/business/individualEntry/individualEntry')">
						</u-button>
					</view>
				</u-col>
			</u-row>
		...
		<view class="">
			...
			<u-row customStyle="margin-top:30rpx;margin-bottom: 10px" gutter="20">
				<u-col span="10" offset="3">
						<u--text color="red" :text="entryInstructions[0].title"  :size="40"></u--text>
				</u-col>
				</u-row>
				<u-col span="15">
