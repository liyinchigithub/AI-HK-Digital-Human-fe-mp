<template>
	<view class="list">
		<!-- 空数据 -->
		<view class="">
			<u-empty  marginTop="100rpx" :show="isEmpty" mode="data" icon="http://cdn.uviewui.com/uview/empty/data.png"
				:width="screenWidth" :height="screenHeight" textSize="40">
			</u-empty>
		</view>
		<!-- 列表数据 -->
		<view v-for="(collect, index) in collectList" :key="index" v-show="!isEmpty">
			<view class="item">
				<u-swipe-action>
					<u-swipe-action-item :options="options1" @click="swipeActionItemClick(collect._id)">
						<view class="swipe-action u-border-top u-border-bottom">
							<view class="swipe-action__content">
								<u-row customStyle="margin-bottom: 10px" gutter="12">
									<u-col span="3"  @click="goto(`/pages/business/goodsDetail/goodsDetail?_id=${collect.goodsID}`)">
										<u--image :showLoading="true" :src="collect.goodsImage" width="80px"
											height="80px" ></u--image>
									</u-col>
									<u-col span="8"  @click="goto(`/pages/business/goodsDetail/goodsDetail?_id=${collect.goodsID}`)">
