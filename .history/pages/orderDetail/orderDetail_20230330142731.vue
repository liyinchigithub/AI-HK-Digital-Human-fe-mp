  ...
  <view>
    <uni-card>
      <view class="">
        <u--image
          :showLoading="true"
          :src="orderDetailData.coverImage.url"
          width="100%"
          height="300px"
        >
        </u--image>
    ...
    <uni-card>
      <view class="content">
        <u--text
          :text="orderDetailData.contentsConsultation"
          size="30"
        ></u--text>
      </view>
    </uni-card>
    ...
    getOrderData() {
      ...
      uniCloud
        ...
        .then((res) => {
          ...
          console.log(res);
          // 新旧数据拼接
          this.orderDetailData.contentsConsultation =
            res.result.data[0].contentsConsultation;
