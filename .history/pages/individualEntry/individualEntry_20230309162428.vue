		...
		<u--form labelPosition="top" :model="formData" :rules="rules" ref="form">
			...
			<uni-card :is-shadow="true" is-full>
				...
				<u-form-item labelWidth="150" prop="userInfo.username"  ref="item1">
					<u--input  width="50" clearable v-model="formData.userInfo.username" border="bottom"
			...
			<uni-card :is-shadow="true" is-full>
				...
				<u-form-item labelWidth="150" prop="userInfo.category"  
					ref="item1">
					<u--input holdKeyboard="true" @focus="showCategory = true" v-model="formData.userInfo.category" required placeholder="请选择分类" border="bottom">
					</u--input>
				</u-form-item>
			</uni-card>
			<!-- 联系方式 -->
			<uni-card :is-shadow="true" is-full>
				...
				<u-form-item labelWidth="150" prop="userInfo.phone"  ref="item1">
					<u--input type="number" width="50" clearable v-model="formData.userInfo.phone" border="bottom"
						@clear="clearInputTitle"></u--input>
				</u-form-item>
			</uni-card>
			<!-- 联系地址 -->
			...
			<uni-card :is-shadow="true" is-full>
				...
				<u-form-item labelWidth="150" prop="userInfo.idcard"  ref="item1">
					<u--input type="idcard" width="50" clearable v-model="formData.userInfo.idcard" border="bottom"
						@clear="clearInputTitle"></u--input>
				</u-form-item>
			</uni-card>
			<!-- 身份证正面 -->
