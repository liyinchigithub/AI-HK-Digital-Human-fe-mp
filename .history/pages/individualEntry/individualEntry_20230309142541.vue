	...
	<view>
		...
		<u--form labelPosition="top" :model="formData" :rules="rules" ref="form">
			...
			<uni-card :is-shadow="true" is-full>
				...
				<u-form-item labelWidth="150" prop="userInfo.gender" borderBottom ref="item1">
					<u-radio-group :labelSize="40" :iconSize="40" shape="circle" v-model="formData.userInfo.gender"
						placement="column" @change="genderGroupChange">
						<u-radio :labelSize="40" :iconSize="40" :customStyle="{ marginBottom: '8px' }"
			...
			<uni-card :is-shadow="true" is-full>
				...
				<u-form-item labelWidth="150" prop="userInfo.contactAddress" borderBottom ref="item1">
					<u--input type="string" width="50" clearable v-model="formData.userInfo.contactAddress"
						border="surround" @clear="clearInputTitle" @focus="selectMap('contactAddress')"></u--input>
				</u-form-item>
			</uni-card>
			<!-- 常驻地址 -->
			<uni-card :is-shadow="true" is-full>
				<uni-section title="常驻地址" type="line"> </uni-section>
				<u-form-item labelWidth="150" prop="userInfo.residentAddress" borderBottom ref="item1">
					<u--input type="string" width="50" clearable v-model="formData.userInfo.residentAddress"
						border="surround" @clear="clearInputTitle" @focus="selectMap('residentAddress')"></u--input>
				</u-form-item>
			</uni-card>
			<!-- 身份证号 -->
			<uni-card :is-shadow="true" is-full>
			...
			<uni-card :is-shadow="true" is-full>
				...
				<view class="example-body">
					<uni-file-picker limit="1" title="最多选择1张图片" fileMediatype="image" mode="grid"
			...
			<uni-card :is-shadow="true" is-full>
				...
				<view class="example-body">
					<uni-file-picker limit="9" title="最多选择9张图片" fileMediatype="image" mode="grid"
			...
			<uni-card :is-shadow="true" is-full>
				...
				<u-form-item labelWidth="150" prop="userInfo.mark" borderBottom ref="item1">
					<u--textarea count autoHeight border="surround" v-model="formData.userInfo.mark" placeholder="请输入">
					</u--textarea>
				</u-form-item>
			</uni-card>
		</u--form>
					...
					.then((res) => {
						...
						uniCloud.callFunction({
							...
							data: {
								...
								imageIDFront: this.formData.userInfo.imageIDFront,
								imageIDReverse: this.formData.userInfo.imageIDReverse,
								imageSkillCertificate: this.formData.userInfo.imageSkillCertificate,
