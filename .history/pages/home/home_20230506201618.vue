	...
	<view>
		...
		<view>
			<u-grid :border="true" col="3" align="center">
				<u-grid-item v-for="(listItem,listIndex) in diamondRegionList" :key="listIndex" bgColor="#ffffff"  @click="goto(listItem.url)">
		...
		<u-sticky bgColor="#fff">
			<!-- 我要入驻 -->
			<uni-card :is-shadow="true" is-full @click="goto('/pages/settleIn/settleIn')">
		...
		<!-- 悬浮球 -->
		<moFabToRelease :defaultPost="right" :defaultY="450" :type="type" :defer="false" />
