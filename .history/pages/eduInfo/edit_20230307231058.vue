  ...
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validate-trigger="submit" err-show-type="toast">
      ...
      <uni-forms-item name="contentsConsultation" label="内容">
        <textarea auto-height :maxlength="-1" placeholder="请输入" @input="binddata('contentsConsultation', $event.detail.value)" class="uni-textarea-border" v-model="formData.contentsConsultation"></textarea>
      </uni-forms-item>
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("eduInfoType,title,contentsConsultation,coverImage,imageList,videoSrc,dateTime,isEnable").get().then((res) => {
