        ...
        <u-swipe-action-item :options="options1" @click="swipeActionItemClick(collect._id)">
          <view class="swipe-action u-border-top u-border-bottom">
            <view class="swipe-action__content">
			  <u--image :showLoading="true" :src="collect.goodsImage" width="80px" height="80px" @click="click"></u--image>
              <text class="swipe-action__content__text">{{collect.goodsName  }}</text>
              <text class="swipe-action__content__text">{{collect._id  }}</text>
            </view>
          </view>
        </u-swipe-action-item>
      </u-swipe-action>
...
export default {
  ...
  methods: {
	...
	swipeActionItemClick(id){
		...
		// 调试输出
		console.log(`deleteCollect id:${id}`)
