<template>
	<view>
		<!-- 入驻说明 -->
			<u-steps current="2"  >
				<u-steps-item title="申请" desc="填写申请表" :iconSize="250" :labelSize="250">
				</u-steps-item>
				<u-steps-item title="审核" desc="官方审核" :iconSize="250" :labelSize="250"></u-steps-item>
				<u-steps-item title="入驻成功" desc="可抢单/接单/派单" :iconSize="250" :labelSize="250"></u-steps-item>
			</u-steps>
		<view class="">
