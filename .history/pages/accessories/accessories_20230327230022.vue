<template>
	...
	<view>
		<!-- 搜索 -->
		<u-search inputAlign="center" height="70" searchIconColor="#409EFF" :searchIconSize="50" shape="square" :clearabled="true" :showAction="true" actionText="搜索" :animation="true" @custom="search()" @search="search()"></u-search>
		<!-- 列表内容 -->
