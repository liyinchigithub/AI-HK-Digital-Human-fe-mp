	...
	<view class="">
		...
		<u--form labelPosition="top" :model="formData" :rules="rules" ref="form">
			<uni-card :is-shadow="true" is-full>
				<uni-section title="发布标题" type="line">
				</uni-section>
				<u-form-item labelWidth="150" prop="userInfo.title" borderBottom ref="item1">
			...
			<uni-card :is-shadow="true" is-full>
				...
				<u-form-item labelWidth="150" prop="userInfo.content" borderBottom ref="item1">
			...
			<uni-card :is-shadow="true" is-full>
				<uni-section title="上门服务时间" type="line">
				</uni-section>
			...
			<uni-card :is-shadow="true" is-full>
				<uni-section title="拍照上传" type="line">
				</uni-section>
				<view class="example-body">
