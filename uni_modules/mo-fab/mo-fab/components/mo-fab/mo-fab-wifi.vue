<template>
	...
	>
		<view>
			...
			<template v-else>
				<view class="mo-fab--wrap" @click="content_wf()">
					<u-row gutter="16">
						<u-icon name="wifi" color="#409EFF" size="30"></u-icon>
					</u-row>
					<br/>
					<u-row gutter="16">
						<text >WiFi</text>
 ...
 */
	export default {
		...
		methods: {
			...
			// wifi连接
			content_wf() {
				// // TODO 请求云函数获取当前空间的wifi账号和密码
				// var wifi_account="wifiaaaa"
				// var wifi_password="123456"
				// // 
				// uni.showModal({
				//     title: '提示',
				//     content: `账号:${wifi_account} 
				// 			 密码：${wifi_password}`,
				// 	confirmText:"一键连接",
				// 	cancelText:"复制",
...
<style lang="scss" scoped>
	.mo-fab {
		...
		&--wrap{
			...
			width: 100rpx;
			color: #409EFF;
			box-shadow: 0px 7rpx 18rpx 0px rgba(150, 162, 215, 0.4);
