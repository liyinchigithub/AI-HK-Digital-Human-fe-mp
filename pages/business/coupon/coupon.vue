<template>
	<view>
		<!-- 分段tab -->
		<u-subsection :list="tabList" :current="curNow" @change="tabChange" fontSize="30rpx" inactiveColor="#71d5a1"
			activeColor="#71d5a1"></u-subsection>
		<!-- 空数据 -->
		<view class="">
		...
		<!-- 优惠券列表 -->
		<view class="" :show="!isEmpty" v-for="(item,index) in newsList" :key="index">
