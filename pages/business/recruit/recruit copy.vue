	...
	<view>
		...
		<u--form labelPosition="top" :model="formData" :rules="rules" ref="form">
			...
			<uni-card :is-shadow="true" is-full>
				...
				<u-form-item label="申请人姓名" required labelWidth="200" prop="userInfo.username" ref="item1">
			...
			<!-- 性别 -->
			<uni-card :is-shadow="true" is-full>
				<uni-section title="请选择性别" type="line"> </uni-section>
				<u-form-item labelWidth="150" prop="userInfo.gender" ref="item1">
					<u-radio-group label="性别" required  shape="square"
						v-model="formData.userInfo.gender" placement="column" @change="genderGroupChange">
						<u-radio placement="row" labelSize="30upx" iconSize="30upx" :customStyle="{ marginBottom: '8px' }"
			...
			<uni-card :is-shadow="true" is-full>
				...
				<u-form-item label="服务技能" required labelWidth="150" prop="userInfo.category" ref="item1">
			...
			<uni-card :is-shadow="true" is-full>
				...
				<u-form-item label="联系方式" required labelWidth="150" prop="userInfo.phone" ref="item1">
			...
			<uni-card :is-shadow="true" is-full>
				...
				<u-form-item label="联系地址" required labelWidth="150" prop="userInfo.contactAddress" ref="item1">
			...
			<uni-card :is-shadow="true" is-full>
				...
				<u-form-item label="常驻地址" required labelWidth="150" prop="userInfo.residentAddress" ref="item1">
					<u--input placeholder="请输入" type="string" width="50" clearable
						v-model="formData.userInfo.residentAddress" border="bottom" @clear="clearInputTitle"
						@focus="selectMap('residentAddress')"></u--input>
				</u-form-item>
			</uni-card>
			<!-- 身份证号 -->
			<uni-card :is-shadow="true" is-full>
				<!-- <uni-section title="身份证号" type="line"> </uni-section> -->
				<u-form-item label="身份证号" required labelWidth="150" prop="userInfo.idcard" ref="item1">
					<u--input placeholder="请输入" type="idcard" width="50" clearable v-model="formData.userInfo.idcard"
						border="bottom" @clear="clearInputTitle"></u--input>
				</u-form-item>
			</uni-card>
			<!-- 身份证正面 -->
			<uni-card :is-shadow="true" is-full>
				...
				<view class="example-body">
					<uni-file-picker limit="1" title="仅1张" fileMediatype="image" mode="grid" @select="selectIDFront"
						@progress="progressIDFront" @success="successIDFront" @fail="fail">
					</uni-file-picker>
				</view>
			</uni-card>
			<!-- 身份证反面 -->
			<uni-card :is-shadow="true" is-full>
				...
				<view class="example-body">
					<uni-file-picker limit="1" title="仅1张" fileMediatype="image" mode="grid" @select="selectIDReverse"
			...
			<uni-card :is-shadow="true" is-full>
				...
				<u-form-item label="备注" required labelWidth="150" prop="userInfo.mark" ref="item1">
